...
http://junit.org/junit5/docs/current/user-guide[JUnit 5] is the latest version of the well-known `JUnit` test framework.
...
++++
<sample xmlns:xi="http://www.w3.org/2001/XInclude" id="jupiterdependencies" dir="testing/junitplatform/jupiter" title="Jupiter Engine Dependencies">
...
++++
<sample xmlns:xi="http://www.w3.org/2001/XInclude" id="jupiterexample" dir="testing/junitplatform/engine/src/test/java/org/gradle/junitplatform" title="Jupiter Test Example">
    <sourcefile file="JupiterTest.java" snippet="jupiter-example"/>
</sample>
++++
